	...
	<body>
		...
		<div id="show-poem" class="content scaffold-show" role="main">
			...
			<ol class="property-list poem">
				...
				<g:if test="${poemInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="poem.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${poemInstance}" field="name"/></span>
