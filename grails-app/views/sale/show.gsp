	...
	<body>
		...
		<div id="show-sale" class="content scaffold-show" role="main">
			...
			<ol class="property-list sale">
				...
				<g:if test="${saleInstance?.amount}">
				<li class="fieldcontain">
					<span id="amount-label" class="property-label"><g:message code="sale.amount.label" default="Amount" /></span>
					
						<span class="property-value" aria-labelledby="amount-label"><g:fieldValue bean="${saleInstance}" field="amount"/></span>
